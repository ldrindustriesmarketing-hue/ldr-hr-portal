            ...
            <div className="border-t pt-6">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg space-y-3">
                <div>
                  ...
                  <input type="text" value={hazard} onChange={(e) => setHazard(e.target.value)} className="w-full px-4 py-2 border rounded-lg text-black" placeholder="e.g., Forklift operation in loading bay" disabled={loading} />
                </div>
